<template>
  <section class="w-1/2 h-full overflow-y-auto px-8 py-8 bg-surface border-r border-surface-container">
    <div class="flex justify-between items-end mb-8">
      <div>
        <h2 class="text-3xl font-extrabold text-on-surface headline tracking-tight">Focus Flow</h2>
        <p class="text-on-surface-variant font-medium text-sm mt-1">You have 4 priority tasks for today.</p>
      </div>
...
const tasks = ref([
  {
    ...
    iconFill: false,
    title: 'Finalize Design Proposals',
    description: 'Review all wireframes and finalize the high-fidelity mockups for the Architectural Task project. Client expects files by EOD.',
    ...
    avatars: [
      {
        alt: 'portrait of a woman with a smiling expression',
      ...
      {
        alt: 'portrait of a bearded man wearing glasses',
  ...
  },
  {
    ...
    description: 'Discuss sprint progress, blockers, and upcoming milestones for the Q2 roadmap.',
